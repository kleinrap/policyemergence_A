...
\begin{figure}
\centering
\includegraphics[width = 0.95\linewidth, angle = 0]{figures/Predation_Q1_popsWolfSheep}
...
\begin{figure}
\centering
\includegraphics[width = 0.95\linewidth, angle = 0]{figures/Predation_Q1_popsGrass}
